 ...
 *
 * Once the license is installed, you can run this class as a JUnit test after
 * removing the line <skipTests>true</skipTests> from pom.xml.
 */
public class MyVaadinIT extends TestBenchTestCase {
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/travauxetservices");
    }
